    ...
    async with client:
        for attachment in attachments:
            if attachment.type and attachment.type == "image/png":
                print("trying to download image from URL:", attachment.url)
...
def start() -> None:
    ...
    if answer.custom_content and answer.custom_content.attachments:
        print(answer)
        asyncio.run(_save_images(answer.custom_content.attachments))
    else:
